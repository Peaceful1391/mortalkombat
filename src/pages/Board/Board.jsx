...
const Board = () => {
  ...
  let { playerOne, playerTwo } = selectedFightersData;
  ...
  const handleClick = (id, player) => {
    ...
    if (player === 'playerOne') {
      setFightersData(
      {
      playerOne: {...fighters[id - 1]},
      playerTwo: {...selectedFightersData.playerTwo},
      }
      )
      } else {
      setFightersData(
      {
      playerOne: {...selectedFightersData.playerOne},
      playerTwo: {...fighters[id - 1]},
      }
      )
      }
  ...
  useEffect(() => {
    console.log(selectedFightersData);
  }, [])
